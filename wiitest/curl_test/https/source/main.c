...
*/
    ...
    /* TLS: disable verification for local testing */
...
int main(void) {
    ...
    curl_easy_setopt(easy, CURLOPT_URL, "https://192.168.15.152:8000/");
    curl_easy_setopt(easy, CURLOPT_WRITEFUNCTION, write_cb);
    curl_easy_setopt(easy, CURLOPT_WRITEDATA, &body);
    curl_easy_setopt(easy, CURLOPT_ERRORBUFFER, errorbuf);
    ...
    terminal_print("curl: performing GET https://192.168.15.152:8000/");
    cc = curl_easy_perform(easy);
