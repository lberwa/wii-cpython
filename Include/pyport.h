...
/* Minimal compatibility shim for embedded targets (e.g. devkitPPC/Wii). */
#if !defined(HAVE_SIGINTERRUPT) && !defined(_Py_SIGINTERRUPT_SHIM)
static inline int
_Py_siginterrupt_stub(int sig, int flag)
{
    (void)sig;
    (void)flag;
    return 0;
}
#define siginterrupt _Py_siginterrupt_stub
#define _Py_SIGINTERRUPT_SHIM 1
#endif
