...
CFLAGS=$(echo "-mhard-float -g -O2 -Wall -Wstrict-prototypes -fPIC -I. -I/opt/devkitpro/extras/bitmap/include -Os -Wall -DTERMINAL_PRINT_DEBUG -DWII_BUILD" | sed "s#$prefix#$prefix_real#")
VERSION="3.15"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
