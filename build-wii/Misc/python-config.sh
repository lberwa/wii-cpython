...
CFLAGS=$(echo "-mhard-float -g -O2 -Wall -Wstrict-prototypes -fPIC -I. -I/opt/devkitpro/extras/cpython/3.15.0a7/bitmap/include -Os -Wall -DTERMINAL_PRINT_DEBUG -DWII_BUILD" | sed "s#$prefix#$prefix_real#")
VERSION="3.15"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
ABIFLAGS=""
LIBS="  -latomic $SYSLIBS"
LIBS_EMBED="-lpython${VERSION}${ABIFLAGS}  -latomic $SYSLIBS"
...
LIBPL=$(echo "$(LIBDEST)/config-$(VERSION)$(ABIFLAGS)" | sed "s#$prefix#$prefix_real#")
SO=".cpython-315.so"
PYTHONFRAMEWORK=""
